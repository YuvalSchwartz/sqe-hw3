...
## How we tested:
1. We started by creating the [story files](moodleProvengo/spec/js/OrderPizza.story.js).
2. We then ran the following command to generate the test model:
```shell
provengo analyze -f PDF helloprovengo   
```
3. We repeated steps 1-2 until we were satisfied with the generated model.
4. We added [Event definitions](moodleProvengo/spec/js/OrderPizza.EventDef.js) to define how the stories actuate the website using Selenium.
...
8. We copied the generated graph of the model to a file named "model.pdf" inside this directory (the link should work).

### Story files
The test stories are in [Tests.story.js](moodleProvengo/spec/js/OrderPizza.story.js). See the file for a detailed description of the stories.
...
The specification for the events are given in [EventDef.js](moodleProvengo/spec/js/OrderPizza.EventDef.js). See the file for a detailed description of the events.
